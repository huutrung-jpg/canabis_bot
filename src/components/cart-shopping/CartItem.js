    ...
    return (
        <div className='py-4 px-2 sm:px-4 border-b'>
            <div className='flex justify-between'>
                <div className='flex'>
                    <img className='w-[60px]' src={item.image} alt={item.productName}/>
                    <span className='pl-3 pt-2 text-[14px] font-semibold sm:text-lg'>{item.productName}</span>
                </div>
            ...
            <div className='flex justify-between items-center relative mt-4 sm:mt-2 sm:justify-end'>
                <div className='relative bottom-0 right-0 text-lg sm:absolute sm:right-[300px]'>{item.price} ISK</div>
                ...
                <span className='text-lg'>{sum} ISK</span>
            </div>
        </div>
    )
}
